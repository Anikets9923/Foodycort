                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="flex justify-between items-start gap-4">
                      ...
                      <div className="text-right">
                        <p className="font-extrabold text-lg text-gray-950 dark:text-zinc-50">₹{order.totalPrice.toFixed(2)}</p>
                    ...
                    <div className="p-3 bg-gray-50/70 dark:bg-zinc-800/40 rounded-2xl flex items-center justify-between border border-gray-100 dark:border-zinc-850">
            ...
            <tbody className="divide-y divide-gray-50 dark:divide-zinc-800/50 text-xs text-gray-600 dark:text-zinc-300">
              {completedOrders.map((order) => (
                <tr key={order.id} className="hover:bg-gray-50/40 dark:hover:bg-zinc-800/20 transition-all">
                  ...
                  <td className="px-6 py-4 font-mono text-[10px] text-gray-450 uppercase">{order.paymentStatus}</td>
